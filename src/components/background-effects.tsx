...
export function GradientMeshBackground({ variant = 'primary' }: { variant?: 'primary' | 'secondary' | 'tertiary' }) {
  ...
  return (
    <div className={`absolute inset-0 bg-gradient-to-br ${gradients[variant]} -z-10`}>
...
export function SectionBackground({ children, variant = 'gradient', className = '' }: SectionBackgroundProps) {
  return (

...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Learn ancient practices that can help you start your day with energy, clarity, and balance.",
  ...
  },
  {
    ...
    excerpt: "Explore time-tested Ayurvedic solutions to combat seasonal allergies without side effects.",
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Stay informed with the latest insights on Ayurvedic healing, natural remedies, and wellness tips.
        </p>
      </div>

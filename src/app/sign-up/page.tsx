...
const SignUpPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-yellow-50 relative overflow-hidden flex items-center justify-center py-8">
      ...
      <div className="w-full max-w-md p-6 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-emerald-700 font-medium">
            Join our Ayurvedic wellness community
          </p>
